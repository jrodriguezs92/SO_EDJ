...
#$SCRIPTPATH/bin/bclient localhost 8007 file.txt 10 2

#GIF type file
$SCRIPTPATH/bin/bclient localhost 8007 img.gif 10 5

#Video mp4 type 
$SCRIPTPATH/bin/bclient localhost 8007 strokes.mp4 3 2

#HTL type file  
$SCRIPTPATH/bin/bclient localhost 8007 404.html  20 2